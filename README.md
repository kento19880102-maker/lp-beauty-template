# 美容業種（ネイル・エステ・個人サロン）向け LP テンプレート

ネイル・エステ・フェイシャルなどの個人サロン向けにカスタマイズ済みの、Next.js 16 / TypeScript / Tailwind CSS v4 の1ページLPテンプレートです。架空のサロン「Salon AOI」をダミーコンテンツとして入れています。
