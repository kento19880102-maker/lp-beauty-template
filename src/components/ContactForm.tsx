    ...
    <section id="contact" className="section max-w-full overflow-hidden">
      <div className="container grid min-w-0 gap-10 md:grid-cols-[.9fr_1.1fr]">
        ...
        {submitted ? (
          ...
          <form className="card reveal grid w-full min-w-0 max-w-full gap-4 overflow-hidden p-5 md:p-8" onSubmit={handleSubmit}>
            ...
            <button className="btn btn-primary mx-1 mt-2 max-w-full px-5 text-center sm:mx-0" type="submit" aria-label={`${site.cta.label}ために送信`}>
              {site.cta.label}
            </button>
          </form>
        )}
